...
OPTFLAG = -O3
# OPTFLAG = -Og
CFLAGS = -c -g $(OPTFLAG) -Wall -std=c++2a -flto -MMD -MP
FINAL_CFLAGS = -g $(OPTFLAG) -Wall -std=c++2a -flto
LDLIBS = 
...
# for test
TEST_OPTFLAG = -Og
TEST_CFLAGS = -c -g $(TEST_OPTFLAG) -Wall -std=c++2a -flto -MMD -MP
TEST_FINAL_CFLAGS = -g $(TEST_OPTFLAG) -Wall -std=c++2a -flto
